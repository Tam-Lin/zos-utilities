...
def test_lpar_parse_d_m_core():
    input = ["IEE174I 14.41.05 DISPLAY M 124                  ",
    ...
    test_lpar.parse_d_m_core(input)

    assert test_lpar.hiperdispatch == True
